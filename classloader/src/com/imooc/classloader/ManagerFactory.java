...
/**
 * @author dayu
 * @version 创建时间：2017年12月22日 下午4:51:19 类说明
 */
public class ManagerFactory
{
	...
	// 要加载的类的classpath
	private static final String CLASS_PATH = "D:/work_space/MyCloud/classloader/bin/";
	...
	public static BaseManager getManager(String className)
	{
		...
		// loadTimeMap不包含className位key的LoadInfo信息，证明这个类没被加载，需要加载到JVM
